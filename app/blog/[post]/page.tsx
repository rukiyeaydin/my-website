...
const fallbackImage: string =
  "https://raw.githubusercontent.com/example/example.com/main/public/images/illustrations/blog.png";
...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: `${post.title}`,
    metadataBase: new URL(`https://example.com/blog/${post.slug}`),
    description: post.description,
    publisher: post.author.name,
    keywords: post.tags,
    alternates: {
      canonical:
        post.canonicalLink || `https://example.com/blog/${post.slug}`,
    },
    openGraph: {
      images:
        fallbackImage,
