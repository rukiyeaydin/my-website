                ...
                <div className="flex flex-wrap gap-4">
                    {skills.map((skill) => {
                        ...
                        return (
                            <div
                                key={skill.name}
                                className="flex items-center space-x-2 p-2 border rounded-3xl group transform transition-all duration-300 ease-in-out hover:scale-105 hover:bg-[rgba(var(--skill-color))] hover:border-[rgba(var(--border-color))]"
